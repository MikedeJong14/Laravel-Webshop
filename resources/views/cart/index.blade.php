    ...
    @if($cartProducts ?? '')
        @foreach($cartProducts as $product)
            <div class="card card-body bg-light mb-1">
                <a href="/cart/destroy/{{$product->id}}" title="Remove item" class="btn btn-light far fa-times-circle fa-2x p-0" style="width: 34px; position: absolute; right: 18px;"></a>
                ...
                <div style="position: absolute; right: 100px; top: 16px;">
                    ...
                    {!! Form::open(['action' => ['CartController@update', $product->id], 'method' => 'POST']) !!}
